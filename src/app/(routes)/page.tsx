...
export default async function HomePage() {
	...
	const vegetables = data.filter((product) => product.category === "vegetable").slice(0, 4);
	const fruits = data.filter((product) => product.category === "fruit").slice(0, 4);
	return (
		<Shell as="div" className="gap-12">
			...
			>
				...
				<Link href={"/vegetables"}>
					<Button className="bg-green-500 hover:bg-green-600">Shop now</Button>
				</Link>
			</section>
