								...
								<div className='flex items-center space-x-1'>
									<Input
										...
										onChange={(e) => {
											...
											updateCartItemQuantity(product.id, Number(e.target.value));
										}}
									/>
									<Button variant="outline" size="icon" className='h-8 w-8 bg-red-500 hover:bg-red-400 text-white hover:text-white' onClick={() => {
